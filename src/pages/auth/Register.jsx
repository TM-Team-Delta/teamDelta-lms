...
const Register = () => {
  ...
  return (
    <div className='w-full'>
      {/* heading */}
      <h1 className='text-2xl font-bold text-text-primary text-center mb-1'>Sign Up</h1>
      <p className='text-sm text-text-secondary text-center mb-6'>Start learning and tracking your progress</p>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <div>
          ...
          <PasswordInput
            ...
            onChange={handleChange}
            hasError={formData.confirmPassword.length > 0 && formData.confirmPassword !== formData.password}
          />
        </div>
      ...
      <p className='text-center text-xs text-text-secondary mt-3'>
        ...
        <span className='underline cursor-pointer hover:text-text-primary'>Terms and Conditions</span>
      </p>
    </div>
  );
};
